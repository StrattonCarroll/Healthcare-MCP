...
try:
    ...
    logging.warning("OpenAI package not available. LLM-based guardrail checks will be disabled.")
...
if OPENAI_AVAILABLE:
    ...
    if api_key:
        ...
        logger.warning("OPENAI_API_KEY not found in environment. LLM-based guardrail checks will be disabled.")
